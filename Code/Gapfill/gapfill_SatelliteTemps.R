...
save(prediction, ciLo, ciUp, file = "data/SatelliteTemps_gapfill.RData")


## summary images
jpeg("figs/SatelliteTemps.jpeg", 1000, 700)
Image(abind(data, prediction, along = 3))
dev.off()

jpeg("figs/SatelliteTemps_ci.jpeg", 1000, 700)
Image(abind(ciLo, ciUp, along = 3))
dev.off()

jpeg("figs/SatelliteTemps_ci.jpeg", 500, 700)
Image(ciUp-ciLo)
dev.off()
