...
coords <- as.matrix(read.table("../../coords-sim.mod"))
X <- as.matrix(read.table("../../x-sim.mod"))
y <- as.matrix(read.table("../../y-sim.mod"))[,1]

coords.ho <- as.matrix(read.table("../../coords-sim.ho"))
X.ho <- as.matrix(read.table("../../x-sim.ho"))
y.ho <- as.matrix(read.table("../../y-sim.ho"))[,1]
...
write.csv(file="pp-sim-pred.csv", t(pred.q), row.names=F)
